...
<body class="stage3">
	...
	<div class="listaciudades">
		...
		<div class="countries">
			<!-- AFRICA -->
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Not yet">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=China">
				<div class="flag-asia">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Japan">
				<div class="flag-asia">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=North Korea">
				<div class="flag-asia">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Saudi Arabia">
				<div class="flag-asia">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Turkey">
				<div class="flag-asia">
			...
			<!-- EUROPE -->
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Andorra">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Belgium">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Switzerland">
				<div class="flag-europe">
					<img src="img/flags/ch.png" alt="bandera">
					<div class="titulo">CH</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Czech Republic">
				<div class="flag-europe">
					<img src="img/flags/cz.png" alt="bandera">
					<div class="titulo">CZ</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Germany">
				<div class="flag-europe">
					<img src="img/flags/de.png" alt="bandera">
					<div class="titulo">DE</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Denmark">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Spain">
				<div class="flag-europe">
					<img src="img/flags/es.png" alt="bandera">
					<div class="titulo">ES</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Finland">
				<div class="flag-europe">
					<img src="img/flags/fi.png" alt="bandera">
					<div class="titulo">FI</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=France">
				<div class="flag-europe">
					<img src="img/flags/fr.png" alt="bandera">
					<div class="titulo">FR</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=United Kingdom">
				<div class="flag-europe">
					<img src="img/flags/gb.png" alt="bandera">
					<div class="titulo">GB</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Greece">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Hungary">
				<div class="flag-europe">
					<img src="img/flags/hu.png" alt="bandera">
					<div class="titulo">HU</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Ireland">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Italy">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Moldova">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Norway">
				<div class="flag-europe">
					<img src="img/flags/no.png" alt="bandera">
					<div class="titulo">NO</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Poland">
				<div class="flag-europe">
					<img src="img/flags/pl.png" alt="bandera">
					<div class="titulo">PL</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Portugal">
				<div class="flag-europe">
					<img src="img/flags/pt.png" alt="bandera">
					<div class="titulo">PT</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Romania">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Sweeden">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Ukraine">
				<div class="flag-europe">
					<img src="img/flags/ua.png" alt="bandera">
					<div class="titulo">UA</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Vatican">
				<div class="flag-europe">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Canada">
				<div class="flag-namerica">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Cuba">
				<div class="flag-namerica">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Mexico">
				<div class="flag-namerica">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=United States">
				<div class="flag-namerica">
			...
			<!-- OCEANIA -->
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Australia">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=New Zealand">
				<div class="flag-oceania">
			...
			<!-- SOUTH AMERICA -->
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Argentina">
				<div class="flag-samerica">
					<img src="img/flags/ar.png" alt="bandera">
					<div class="titulo">AR</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Bolivia">
				<div class="flag-samerica">
					<img src="img/flags/bo.png" alt="bandera">
					<div class="titulo">BO</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Brazil">
				<div class="flag-samerica">
					<img src="img/flags/br.png" alt="bandera">
					<div class="titulo">BR</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Chile">
				<div class="flag-samerica">
					<img src="img/flags/cl.png" alt="bandera">
					<div class="titulo">CL</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Colombia">
				<div class="flag-samerica">
					<img src="img/flags/co.png" alt="bandera">
					<div class="titulo">CO</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Ecuador">
				<div class="flag-samerica">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Peru">
				<div class="flag-samerica">
			...
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Uruguay">
				<div class="flag-samerica">
					<img src="img/flags/uy.png" alt="bandera">
					<div class="titulo">UY</div>
				</div>
			</a>
			<a href="MuCr_Concerts.php?artist=<?php echo $_GET['artist']; ?>&country=Venezuela">
				<div class="flag-samerica">
