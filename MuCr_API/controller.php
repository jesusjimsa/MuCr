	...
	*/
	...
	switch ($_SERVER['REQUEST_METHOD']) {
		case 'GET':
			...
			// Elimina el ultimo elemento del array $data, ya que usualmente, suele traer dos elementos, uno con la informacion,
			// y otro NULL el cual no necesitamos
			array_pop($data);
			...
			if (count($data) == 0) {
				...
				// Pero si la variable Id existe y no trae $data, ya que no buscamos un elemento especifico, significa que la
				// entidad no tiene elementos que msotrar
				}
				else {
