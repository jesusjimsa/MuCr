...
<head>
	<meta charset="utf-8">
	<title>Concerts recommendation</title>
...
<body class="stage3">
	...
	<div class="milibreria_concerts">
		...
		<button class="but_near" onclick="window.location.href='Orpheus_concert_near.php'">
