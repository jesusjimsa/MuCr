    ...
    error_reporting(E_ERROR);
              ...
              $imp="";
							for($i=0;$i<$max;$i++){
								...
								////////////////////////////////////////////////////////////////////////////////////////////////
								$imp.= "<div class=\"concert\">";
                $imp.= "<img src=\"".$imge."\" alt=\"".$title."\">";
                $imp.= "<div class=\"name_artist\">".$title."</div>";
                $imp.=  "<div class=\"location_date\">".$date." at ".$hour."<br/> minimun: ".$min_prec." ".$coin." maximun: ".$max_prec." ".$coin."</div>";
                $imp.=	"<div class=\"city_near\"><img src=\"".$urlcity."\" alt=\"ciudad\"><div class=\"flag\"><img src=\"".$uriFlag."\" alt=\"bandera\"></div><div class=\"titulo\">".$city."</div></div>";
                $imp.="</div>";
