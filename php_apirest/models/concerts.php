...
class Concert{
    ...
    public function updateConcert(){
        ...
        $query = "UPDATE concert SET concert_date = '$udate' WHERE user_email = '$uemail' and concert_city = '$ucity' and concert_date = '$udate' and concert_artist = '$uartist' ";
    ...
    public function deleteConcert(){
        ...
        $ddate = $this->date;
        $dcity = $this->city;
        $demail = $this->user_email;

        $query = "SELECT * FROM U_attended_C WHERE user_email = '$demail' and concert_artist = '$dartist' and concert_date = '$ddate' and concert_city = '$dcity'";

        $result = mysqli_query($this->conn, $query);
        $rows = mysqli_fetch_all($result);

        if ($rows->num_rows != 0) {
            $query = "DELETE FROM U_attended_C WHERE user_email = '$demail' and concert_artist = '$dartist' and concert_date = '$ddate' and concert_city = '$dcity'";
